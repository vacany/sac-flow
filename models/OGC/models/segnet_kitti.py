...
from models.OGC.utils.nn_util import Seq
from models.OGC.utils.pointnet2_util import PointnetFPModule, PointnetSAModuleMSG, PointnetSAModule
from models.OGC.utils.transformer_util import MaskFormerHead
...
class MaskFormer3D(nn.Module):
    ...
    def forward(self, pc, point_feats):
        ...
        pointnet_features_pc = l_feats[0].transpose(1, 2).contiguous()

        return mask, pointnet_features_pc
