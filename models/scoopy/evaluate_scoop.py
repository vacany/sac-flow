...
from models.scoopy.networks.refiner import Refiner
from models.scoopy.utils.generic import Batch
from models.scoopy.utils.seed import seed_everything
from models.scoopy.utils.utils import log_string, iterate_in_chunks
...
if __name__ == "__main__":
    ...
    parser.add_argument("--path2ckpt", type=str, default=f"./../pretrained_models/kitti_v_100_examples/model_freespace.tar", help="Path to saved checkpoint.")
